...
*/
module hs_filter #(
    parameter logic __UseLegacyFilter = 1'b0
) (
          hs_io.flw flw_hs,
          hs_io.ldr ldr_hs,
    input logic     pass_i
    ...
    generate
        if (__UseLegacyFilter) begin : g_legacy_filter
            initial $warning("Using deprecated legacy version of hs_filter! This module generates aborts!");
            always_comb begin
